...
class ReferenceCatalog:
    ...
    def _analyze_reference_sync(
        ...
        prompt = (
            ...
            "the person appears under 18, an outer jacket or zip-up hoodie covers/overlaps the sides of the garment panel, "
    ...
    def _validate_reference_for_generation_sync(
        ...
        prompt = (
            ...
            "directly covering the print location. print_area_visibility is the usable torso percentage. "
    ...
    def status_text(self) -> str:
        ...
        waiting_lines = [
            f"Очередь загрузки ссылок: {pending}",
            f"Сейчас загружается и анализируется: {processing}",
            f"Повторная загрузка после ошибки: {retry}",
        ]
