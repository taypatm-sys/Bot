...
class MockupGenerator:
    ...
    def _analyze_mockup_source_guided_sync(
        ...
        prompt = (
            ...
            "Read and transcribe any text written in the print artwork exactly (e.g. 'I NEED A HUG FROM A BAD BITCH'). "
            "Infer target_gender, mood tags and print_theme STRICTLY from the graphic/text printed on the garment. "
            "Do not invent unrelated themes like cats unless cats are actually drawn in the print. "
