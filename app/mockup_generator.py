...
class MockupGenerator:
    ...
    def _analyze_mockup_source_guided_sync(
        ...
        prompt = (
            ...
            "color, fabric finish, fit and construction. "
            "CRITICAL: Examine the DTF printed artwork on the garment panel very carefully. "
            "Read and transcribe any text written in the print artwork exactly (e.g. 'sportsmenler' or 'I NEED A HUG FROM A BAD BITCH'). "
            "Infer target_gender, mood tags and print_theme STRICTLY from the graphic/text printed on the garment. "
            "Classify target_gender as 'men' for sports, wrestling, grappling, martial arts, athletic, gym, or bold masculine humor/memes (such as wrestling cats or 'sportsmenler'); "
            "classify as 'women' for feminine art; and 'unisex' ONLY for completely neutral graphics without any sports/gender theme. "
            "Keep text fields short. The original product image will be supplied directly to the image generator and will "
    ...
    def _analyze_mockup_sync(
        ...
        *,
        ...
        prompt = (
            ...
            "CRITICAL: Read and transcribe any visible text inside the print artwork exactly. "
            "Infer target_gender (women, men, or unisex), adult age group, mood tags and print_theme STRICTLY from the "
            "printed artwork and text itself, never from background objects or unverified assumptions. "
            "Keep all text fields short. Confidence describes "
    ...
    def _analyze_print_asset_sync(
        ...
        prompt = (
            ...
            "from the artwork: men for sports, wrestling, grappling, martial arts, athletic, gym, or bold masculine humor/memes (such as wrestling cats or 'sportsmenler'); "
            "women for clearly feminine art; and unisex ONLY when completely neutral and without any sports or gender bias. "
            "Infer a broad adult target age group, 1 "
